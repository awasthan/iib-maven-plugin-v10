...
public class CreateBarMojo extends AbstractMojo {
     ...
     */
    @Parameter(property = "iib.includeArtifactsPattern", defaultValue = "**/*.xsdzip,**/*.tblxmi,**/*.xsd,**/*.wsdl,**/*.dictionary,**/*.xsl,**/*.xslt,**/*.xml,**/*.jar,**/*.inadapter,**/*.outadapter,**/*.insca,**/*.outsca,**/*.descriptor,**/*.idl,**/*.map,**/*.msgflow", required = true)
     ...
     */
    @Parameter(property = "iib.toolkitVersion", defaultValue = "10")
    ...
    private List<String> addObjectsAppsLibs() throws MojoFailureException {
       ...
       //If the project is an application, add it as application else add it as library - Added below code on 08/06/2018
        ...
        for (Dependency dependency : project.getDependencies()) {
            ...
            // Updated to exclude Shared library from dependency
